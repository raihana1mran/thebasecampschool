<x-student-layout>
            ...
            <div class="glass-card p-8 rounded-3xl space-y-6 shadow-sm">
                <div class="flex justify-between items-end">
                    <div>
                        ...
                        <h3 class="text-4xl font-bold text-slate-800">41%</h3>
                    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-10 relative z-10">
        ...
        <div class="glass-card p-8 rounded-3xl hover:shadow-2xl hover:shadow-cyan-900/10 transition-all group border-t-[6px] border-t-[#006479] bg-white/40">
            <div class="flex justify-between items-start mb-6">
                <div class="h-16 w-16 rounded-2xl bg-[#006479]/5 border border-[#006479]/10 flex items-center justify-center">
                    <span class="material-symbols-outlined text-[#006479] text-4xl" style="font-variation-settings: 'FILL' 1;">biotech</span>
                </div>
            ...
            <h3 class="text-2xl font-bold mb-2 text-slate-800 tracking-tight">Biology</h3>
            ...
            <div class="space-y-3">
                <a href="{{ route('subpage', '12th-biology') }}" class="w-full signature-gradient text-white py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 hover:scale-[1.02] shadow-md shadow-cyan-900/20 transition-all text-sm">
        ...
        <div class="glass-card p-8 rounded-3xl hover:shadow-2xl hover:shadow-cyan-900/10 transition-all group bg-white/40 border border-slate-200 border-t-4 border-t-cyan-500">
            <div class="flex justify-between items-start mb-6">
                <div class="h-16 w-16 rounded-2xl bg-cyan-50 border border-cyan-100 flex items-center justify-center">
                    <span class="material-symbols-outlined text-cyan-600 text-4xl">electric_bolt</span>
                </div>
            ...
            <h3 class="text-2xl font-bold mb-2 text-slate-800 tracking-tight">Physics</h3>
            ...
            <div class="space-y-3 mt-auto">
                <a href="{{ route('subpage', '12th-biology') }}" class="w-full bg-cyan-600 text-white py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 hover:scale-[1.02] shadow-md shadow-cyan-600/20 transition-all text-sm">
                    Start Learning <span class="material-symbols-outlined text-lg">arrow_forward</span>
                </a>
            </div>
        </div>
        ...
        <div class="glass-card p-8 rounded-3xl hover:shadow-2xl hover:shadow-cyan-900/10 transition-all group bg-white/40 border border-slate-200 border-t-4 border-t-indigo-500">
            <div class="flex justify-between items-start mb-6">
                <div class="h-16 w-16 rounded-2xl bg-indigo-50 border border-indigo-100 flex items-center justify-center">
                    <span class="material-symbols-outlined text-indigo-600 text-4xl">science</span>
                </div>
            ...
            <h3 class="text-2xl font-bold mb-2 text-slate-800 tracking-tight">Chemistry</h3>
            ...
            <div class="space-y-3 mt-auto">
                <a href="{{ route('subpage', '12th-biology') }}" class="w-full bg-indigo-600 text-white py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 hover:scale-[1.02] shadow-md shadow-indigo-600/20 transition-all text-sm">
                    Start Learning <span class="material-symbols-outlined text-lg">arrow_forward</span>
                </a>
            </div>
        </div>
        ...
        <div class="glass-card p-8 rounded-3xl hover:shadow-2xl hover:shadow-cyan-900/10 transition-all group bg-white/40 border border-slate-200 border-t-4 border-t-amber-500">
            <div class="flex justify-between items-start mb-6">
                <div class="h-16 w-16 rounded-2xl bg-amber-50 border border-amber-100 flex items-center justify-center">
                    <span class="material-symbols-outlined text-amber-600 text-4xl">local_library</span>
                </div>
            ...
            <h3 class="text-2xl font-bold mb-2 text-slate-800 tracking-tight">English Core</h3>
            ...
            <div class="space-y-3 mt-auto">
                <a href="{{ route('subpage', '12th-biology') }}" class="w-full bg-amber-500 text-white py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 hover:scale-[1.02] shadow-md shadow-amber-500/20 transition-all text-sm">
                    Start Learning <span class="material-symbols-outlined text-lg">arrow_forward</span>
                </a>
            </div>
        </div>
        ...
        <div class="glass-card p-8 rounded-3xl hover:shadow-2xl hover:shadow-cyan-900/10 transition-all group bg-white/40 border border-slate-200 border-t-4 border-t-rose-500">
            <div class="flex justify-between items-start mb-6">
                <div class="h-16 w-16 rounded-2xl bg-rose-50 border border-rose-100 flex items-center justify-center">
                    <span class="material-symbols-outlined text-rose-600 text-4xl">quiz</span>
                </div>
            ...
            <h3 class="text-2xl font-bold mb-2 text-slate-800 tracking-tight">Test Series</h3>
            ...
            <div class="space-y-3 mt-auto">
                <button class="w-full bg-[#111827] text-white py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 hover:scale-[1.02] shadow-md shadow-slate-900/40 transition-all text-sm">
        ...
        <div class="glass-card p-8 rounded-3xl bg-gradient-to-br from-indigo-50 to-white relative overflow-hidden group border border-slate-200">
            ...
            <div class="relative z-10 flex flex-col h-full justify-between">
                <div>
                    <h3 class="text-2xl font-bold mb-4 text-slate-800 tracking-tight">Need Medical <br/>Mentorship?</h3>
    ...
    <div class="mt-8 pb-16 relative z-10">
        <h4 class="text-3xl font-bold mb-8 text-slate-800 tracking-tight">Latest Milestones</h4>
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-80 glass-card p-10 rounded-[2.5rem] flex flex-col justify-between shadow-sm border border-slate-200 bg-white/50">
                <div>
                    ...
                    <h3 class="text-6xl font-black tracking-tighter text-[#006479]">38 <span class="text-2xl font-bold text-slate-500 tracking-tight">Days</span></h3>
                </div>
                <div class="pt-8">
