...
<div class="fixed top-[-10%] right-[-10%] w-[500px] h-[500px] bg-[#40cef3]/20 rounded-full blur-[120px] -z-10 pointer-events-none"></div>
<div class="fixed bottom-[-5%] left-[-5%] w-[400px] h-[400px] bg-[#80b2ff]/10 rounded-full blur-[100px] -z-10 pointer-events-none"></div>

<div class="p-6 md:p-10 flex flex-col gap-8 relative z-10 w-full max-w-7xl mx-auto">
    ...
    <!-- Mastery Status -->
    <div class="glass-card p-6 rounded-2xl flex items-center gap-6 shadow-sm min-w-[280px]">
    ...
    <div class="glass-card rounded-[2rem] overflow-hidden shadow-2xl relative group border border-slate-200 bg-black">
    ...
    <!-- Chapter Resources -->
    <section class="glass-card p-6 rounded-2xl border border-slate-200 bg-white/50">
    ...
    <!-- Test & Unlock -->
    <section class="signature-gradient p-6 rounded-2xl flex flex-col justify-between text-white shadow-xl shadow-cyan-900/20">
    <div>
    ...
    <div class="mt-6">
    <button class="w-full bg-white text-[#006479] font-bold py-3.5 rounded-xl shadow-lg hover:bg-cyan-50 hover:scale-[1.02] transition-transform flex items-center justify-center gap-2">
    ...
    <div class="w-24 h-16 rounded-xl overflow-hidden flex-shrink-0 relative shadow-sm">
    ...
    <div class="md:col-span-2 glass-card p-8 rounded-2xl flex items-center gap-8 relative overflow-hidden border border-slate-200 shadow-sm bg-white/60">
    <div class="relative z-10 space-y-4">
    <h2 class="text-3xl font-bold tracking-tight text-slate-800">Deep Dive: <br/><span class="gradient-text">Medical Illustrations</span></h2>
    ...
    <button class="px-6 py-2.5 border-2 border-[#006479] text-[#006479] font-bold rounded-full hover:bg-[#006479] hover:text-white transition-all text-xs uppercase tracking-widest">Open 3D Viewer</button>
    </div>
    ...
    <div class="glass-card p-8 rounded-2xl bg-gradient-to-br from-[#40cef3]/10 to-transparent border border-cyan-200 flex flex-col justify-between shadow-sm">
    ...
    <div>
    <h3 class="text-xl font-bold mb-2 text-slate-800">Subject Expert Chat</h3>
